...
export default function NotificationPopup({ show, type, message, onClose, duration = 2500 }) {
  ...
  return (
    <div className="fixed inset-0  z-50 flex justify-center items-center">
      <div className="bg-[#807D7DCC] rounded-xl p-6 w-[250px] h-[250px] text-center shadow-lg">
        <div className="flex justify-center mb-4">
          {type === "success" ? (
            <div className="w-[80px] h-[80px] rounded-full border-4 border-green-500 flex items-center justify-center">
              <svg
