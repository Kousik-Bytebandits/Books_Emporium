...
const ShippingDeliveryPolicy = () => {
  return (
    <div className="mt-[25%] lg:mt-[10%] h-[60vh] max-w-4xl mx-auto px-6 py-10">
      ...
      <ul className="list-disc list-inside space-y-3">
        <li>International orders shipped via registered courier or speed post.</li>
        <li>Domestic orders shipped within 0–7 days depending on order and availability.</li>
        ...
        <li>
          ...
          or{" "}
          <a href="mailto:support@booksemporium.in" className="text-blue-600 underline">
